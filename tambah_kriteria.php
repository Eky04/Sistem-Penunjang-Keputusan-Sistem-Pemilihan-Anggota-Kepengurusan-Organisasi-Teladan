...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($nama_kriteria)) {
        ...
        try {
            ...
            $stmt = $pdo->prepare("
                INSERT INTO kriteria (nama_kriteria, bobot, jenis) 
                VALUES (?, ?, ?)
            ");
            $stmt->execute([$nama_kriteria, $bobot, $jenis]);
...
<head>
    ...
    <title>Tambah Kriteria - Sistem SPK SAW</title>
                    ...
                    <div class="p-4">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0">
                                    <i class="fas fa-plus"></i> Form Tambah Kriteria
                                </h5>
                            </div>
                            <div class="card-body">
                                <?php if ($success): ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="number" class="form-control" id="bobot" name="bobot" 
                                                   ...
                                                   value="<?php echo isset($_POST['bobot']) ? $_POST['bobot'] : ''; ?>" 
                                                   required>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select class="form-select" id="jenis" name="jenis" required>
                                                ...
                                                <option value="benefit" <?php echo (isset($_POST['jenis']) && $_POST['jenis'] == 'benefit') ? 'selected' : ''; ?>>Benefit</option>
                                                <option value="cost" <?php echo (isset($_POST['jenis']) && $_POST['jenis'] == 'cost') ? 'selected' : ''; ?>>Cost</option>
                                            </select>
                                        </div>
                                    </div>
