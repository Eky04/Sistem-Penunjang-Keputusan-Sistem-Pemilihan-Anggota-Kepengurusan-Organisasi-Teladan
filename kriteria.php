...
<head>
    ...
    <title>Data Kriteria - Sistem SPK SAW</title>
                    ...
                    <div class="p-4">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0">
                                    <i class="fas fa-list-check"></i> Daftar Kriteria
                                </h5>
                            </div>
                            <div class="card-body">
                                <?php if (empty($kriteria_list)): ?>
                                    <div class="text-center py-4">
                                        ...
                                        <h5 class="text-muted">Belum ada data kriteria</h5>
                                        <p class="text-muted">Silakan tambah data kriteria terlebih dahulu</p>
                                        <a href="tambah_kriteria.php" class="btn btn-success">
                                            <i class="fas fa-plus"></i> Tambah Kriteria
                                        </a>
                                    </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group">
                                                                <a href="edit_kriteria.php?id=<?php echo $kriteria['id_kriteria']; ?>" 
                                                                   class="btn btn-sm btn-warning" title="Edit">
                                                                    <i class="fas fa-edit"></i>
                                                                </a>
                                                                <button type="button" class="btn btn-sm btn-danger" 
                                                                        onclick="confirmDelete(<?php echo $kriteria['id_kriteria']; ?>, '<?php echo htmlspecialchars($kriteria['nama_kriteria']); ?>')" 
                                                                        title="Hapus">
    ...
    <script>
        ...
        function confirmDelete(id, nama) {
            if (confirm('Apakah Anda yakin ingin menghapus kriteria "' + nama + '"?')) {
                window.location.href = 'hapus_kriteria.php?id=' + id;
            }
        }
    </script>
</body>
