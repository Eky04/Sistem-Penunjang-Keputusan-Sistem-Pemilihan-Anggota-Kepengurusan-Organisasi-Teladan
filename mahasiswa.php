...
<head>
    ...
    <title>Data Anggota Kepengurusan - Sistem SPK SAW</title>
                            ...
                            <div class="card-body">
                                <?php if (empty($mahasiswa_list)): ?>
                                    <div class="text-center py-4">
                                        ...
                                        <p class="text-muted">Silakan tambah data mahasiswa terlebih dahulu</p>
                                        <a href="tambah_mahasiswa.php" class="btn btn-primary">
                                            ...
                                            <tbody>
                                                <?php foreach ($mahasiswa_list as $index => $mahasiswa): ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo htmlspecialchars($mahasiswa['jabatan'] ?? ''); ?></td>
                                                        <?php
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group">
                                                                ...
                                                                <button type="button" class="btn btn-sm btn-danger" onclick="confirmDelete(<?php echo $mahasiswa['id_mahasiswa']; ?>, '<?php echo htmlspecialchars($mahasiswa['nama'] ?? ''); ?>')" title="Hapus">
